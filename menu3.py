...
class Arreglo:
    ...
    def calcularFactorialRecursivo(self, n):
        # Caso base: 0! = 1 y 1! = 1
        if n == 0 or n == 1:
            return 1
        # Llamada recursiva
        else:
            return n * self.calcularFactorialRecursivo(n - 1)
...
def mostrarMenu():
    ...
    print("6. Calcular factorial de un número (recursivo)")
    print("7. Salir")
        ...
        if opcion == "1":
            ...
            try:
                ...
                if n < 0:
                    ...
                    factorial = arreglo.calcularFactorialRecursivo(n)
